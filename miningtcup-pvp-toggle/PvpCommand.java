    ...
    public boolean onCommand(
        ...
        if (args.length == 0) {
            ...
            if (!PvpService.isPvpCooldownDone(player) && !PvpService.isPvpDisabled(player)) {
                ...
                String cooldownMessage = ChatFormatterService.formatTime(remainingCooldownMs) + " of cooldown left.";
                commandSender.sendMessage(ChatFormatterService.addPrefix(cooldownMessage));
                return true;
            }
